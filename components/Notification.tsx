    ...
    <BodyContainer>
      ...
      >
        ...
        >
          ...
          >
            <Typography variant="body2" color="#5F2120">
              <strong>3건</strong>의 받은 서명요청이 있습니다.{" "}
              <strong>어서 확인하세요!! </strong>{" "}
            </Typography>
          </Box>
        </Box>
        <Box
        ...
        >
          ...
          >
            <Typography variant="body2" color="#014361">
              <strong>5건</strong>의 보낸 서명요청이 있습니다.{" "}
              <strong>서명 현황을 확인하세요!! </strong>{" "}
            </Typography>
          </Box>
        </Box>
        <Box
        ...
        >
          ...
          >
            <Typography variant="body2" color="#1E4620">
              <strong>비밀유지계약(with 이나현)</strong> 이 체결되었습니다.{" "}
            </Typography>
          </Box>
        </Box>
      </Box>
