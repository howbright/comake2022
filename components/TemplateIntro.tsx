...
export default function TemplateIntro() {
  return (
    <BodyContainer>
        ...
        <DocsList/>
        <Box sx={{width: '100%',mb:2, p:"20px", justifySelf: 'center',  alignSelf: 'center', height: '100%', overflowy: 'auto',
              display: 'flex', flexDirection: 'column' , justifyItems: 'center', alignItems: 'center', backgroundColor: '#FDEDED'}}>
        <Typography sx={{mb:1}} variant='h6' color='primary.dark'><strong>계약서 양식</strong></Typography>
        <Typography variant='body2'> 계약서 작성이 어려우신가요? </Typography>
        <Typography sx={{maxWidth: '300px', textAlign: 'center'}} variant='caption'> 코메이크는 현직 변호사가 작성한 믿을 수 있는 다양한 계약서 양식을 제공합니다. </Typography>
        <SearchBar />
      </Box>
